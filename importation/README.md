...
Dispite remaining belong connections, the Data Model only display the count of connections table. This is why _ThisWorkbookDataModel_ connection is not directly deletable, neither manually nor by using Vba.
