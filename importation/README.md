...
Though the component that I used and would have described here, the connection tab seems to show only the model object, and the workbook tables which have been opened somewhere else in a workbook or another.
