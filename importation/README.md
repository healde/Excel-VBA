...
### how then
After having composer a whole set of commands to run some tests, I asked for help to AI and it let me knows about some internal process in the Microsoft environment and followed me in my course.
